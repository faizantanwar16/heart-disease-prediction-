    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#FFF5F5", fontFamily: "Inter, sans-serif" }}>
        <div style={{ textAlign: "center", padding: 48 }}>
          ...
          <p style={{ color: "#6B7280", marginBottom: 28 }}>Welcome to HeartGuard, {form.name.split(" ")[0]}. Your heart health journey starts now.</p>
          <a href="/login">
            <button style={{ background: "#C0182B", color: "white", border: "none", padding: "12px 32px", borderRadius: 10, fontWeight: 700, fontSize: 15, cursor: "pointer", fontFamily: "Inter, sans-serif" }}>
    ...
    <div style={{ minHeight: "100vh", display: "flex", fontFamily: "Inter, sans-serif", overflow: "hidden" }}>
      ...
      <div
        style={{
          width: "40%",
          minWidth: 340,
          background: "linear-gradient(160deg, #8B0000 0%, #C0182B 60%, #E53E3E 100%)",
          display: "flex",
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: 30, fontWeight: 900, color: "white", margin: "0 0 12px", letterSpacing: "-0.5px", lineHeight: 1.2 }}>
            Join HeartGuard
          </h1>
      ...
      >
        <div style={{ width: "100%", maxWidth: 460 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            {/* Full Name */}
            <div>
              <label style={{ fontSize: 13, fontWeight: 600, color: "#374151", display: "block", marginBottom: 7, letterSpacing: "0.01em" }}>
                Full Name
              </label>
                ...
                <div style={{ marginTop: 10 }}>
                  <div style={{ display: "flex", gap: 4 }}>
                    {[1, 2, 3].map((level) => {
                      ...
                      const active = passedCount >= level;
                      return (
                        <div
                          key={level}
                          style={{
                            ...
                            height: 4,
                            borderRadius: 4,
                            background: active ? colors[passedCount - 1] : "#E5E7EB",
                  ...
                  <span style={{ fontSize: 11, color: "#9CA3AF", marginTop: 4, display: "block" }}>
                    {passwordRules.filter((r) => r.test(form.password)).length === 0 && "Weak"}
                    {passwordRules.filter((r) => r.test(form.password)).length === 1 && "Fair"}
                    {passwordRules.filter((r) => r.test(form.password)).length === 2 && "Good"}
                    {passwordRules.filter((r) => r.test(form.password)).length === 3 && "Strong"}
                  </span>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    paddingRight: 44,
                    border: `1.5px solid ${
                      passwordMismatch ? "#EF4444" : passwordMatch ? "#16A34A" : focused === "confirm" ? "#C0182B" : "#E5E7EB"
                    }`,
              ...
              {passwordMismatch && (
                <p style={{ fontSize: 12, color: "#EF4444", margin: "6px 0 0", fontWeight: 500 }}>Passwords do not match</p>
              )}
              {passwordMatch && (
                <p style={{ fontSize: 12, color: "#16A34A", margin: "6px 0 0", fontWeight: 500, display: "flex", alignItems: "center", gap: 4 }}>
                  <CheckCircleIcon color="#16A34A" /> Passwords match
                </p>
              )}
            </div>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 10, marginTop: 2 }}>
              <div
                ...
                style={{
                  ...
                  height: 18,
                  borderRadius: 5,
                  border: `2px solid ${agreed ? "#C0182B" : "#D1D5DB"}`,
                  background: agreed ? "#C0182B" : "white",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  cursor: "pointer",
            ...
            <button
              ...
              style={{
                ...
                boxShadow: isFormValid ? "0 4px 16px rgba(192,24,43,0.3)" : "none",
                letterSpacing: "0.01em",
                fontFamily: "Inter, sans-serif",
                marginTop: 4,
              }}
              onMouseEnter={e => { if (isFormValid) { e.currentTarget.style.transform = "translateY(-1px)"; e.currentTarget.style.boxShadow = "0 6px 24px rgba(192,24,43,0.4)"; }}}
              onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = isFormValid ? "0 4px 16px rgba(192,24,43,0.3)" : "none"; }}
            >
              Create Account
            </button>
